...
class Place extends WS_Controller {
	...
	public function index()
	{
        ...
        public function countryview($param=null){
            $this->load->view('template/header');
            $this->load->view('place/countryview');
            $this->load->view('template/footer');
        }
        public function placeview($param=null) {
            ...
            if($placeId){
                ...
                $this->load->view('place/placeview',$data);
            }else{
                $this->load->view('template/header');
