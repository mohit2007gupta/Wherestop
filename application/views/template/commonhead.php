...
var jsPath = "<?php echo base_url(); ?>static/js/";  
window.globalpath = "<?php echo base_url(); ?>static";
</script>
...
<link href="<?php echo base_url(); ?>static/css/ws-theme.css" rel="stylesheet">
<link href="<?php echo base_url('static/lib/bootstrapswitch/bootstrap-switch.css'); ?>" type="text/css" rel="stylesheet" media="screen, projection">
