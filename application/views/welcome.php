        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url(); ?>static/img/ipad.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url(); ?>static/img/doge.png" alt="">
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url(); ?>static/img/phones.png" alt="">
                </div>
            </div>
