<?php 
$cityCoverUrl = base_url("static/images/placecover/india.jpg");
?>
<div class="intro-header ws-container" style="background: url('<?php echo $cityCoverUrl; ?>'); background-size: cover">
